...
function initializeLightbox() {
    ...
    // Add click listeners to resume pages
...
function testLightbox() {
    ...
    console.log('Found resume pages:', resumePages.length);
    
    if (resumePages.length > 0) {
        console.log('Opening lightbox for first image...');
        openLightbox(0);
    } else {
        console.log('No resume pages found');
    }
}